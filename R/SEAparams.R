...
setMethod(
  f = "treat_lfc", signature = "SEAparams",
...
setMethod(
  f = "adjust_method", signature = "SEAparams",
  definition = function(object) {
...
setMethod(
  f = "de_genes", signature = "SEAparams",
  definition = function(object) {
...
setMethod(
  f = "de_cutoff", signature = "SEAparams",
  definition = function(object) {
