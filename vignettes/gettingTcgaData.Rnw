...
All the subjects data mentioned in section \ref{gettingData} was downloaded by 
...
## However we can provide you neccesary files to skip the TCGAdownload step.
...
#### Now lets get subjects subtypes
...
# [1] 796
# the we find into the mapping given by RNASeq TCGA data
