...
\\
\\ Rodriguez JC, Merino GA, Llera AS, Fern\'{a}ndez EA (2019).
\\“Massive integrative gene set analysis enables functional characterization of 
breast cancer subtypes.” \textit{Journal of Biomedical Informatics}, 
\textbf{93}, 103157.
\\
