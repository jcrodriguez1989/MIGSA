...
“Improving information retrieval in functional analysis.” \textit{Computers in 
Biology and Medicine}, \textbf{79}, 10–20.
...
## Lets simulate two expression matrices of 300 genes and 16 subjects.
...
## Lets create randomly 30 gene sets, of 10 genes each
...
## Lets see in which depths of the GO tree are these gene sets
table(getHeights(
